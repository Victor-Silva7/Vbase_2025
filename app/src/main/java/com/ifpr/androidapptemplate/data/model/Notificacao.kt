...
fun Notificacao.getIconeResId(): Int {
    return when (tipo) {
        TipoNotificacao.CURTIDA -> com.ifpr.androidapptemplate.R.drawable.ic_favorite_24dp
        TipoNotificacao.COMENTARIO -> com.ifpr.androidapptemplate.R.drawable.ic_comment_24dp
    }
}
