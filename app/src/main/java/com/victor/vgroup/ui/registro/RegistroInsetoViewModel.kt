...
import com.victor.vgroup.data.model.Inseto
...
import com.victor.vgroup.data.model.UsuarioPostagem
import com.victor.vgroup.data.repository.RegistroRepository
import com.victor.vgroup.utils.ImageUploadManager
...
class RegistroInsetoViewModel : ViewModel() {
    ...
    private val socialService = com.victor.vgroup.data.firebase.SimpleSocialService.getInstance()
