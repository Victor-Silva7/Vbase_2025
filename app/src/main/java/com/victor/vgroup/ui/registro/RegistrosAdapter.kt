...
import com.victor.vgroup.databinding.ItemRegistroCardBinding
                ...
                if (!firstImageId.isNullOrBlank()) {
                    ...
                    CoroutineScope(Dispatchers.IO).launch {
                        try {
                            ...
                            val realtimeManager = com.victor.vgroup.data.firebase.FirebaseConfig.getRealtimeDatabaseImageManager()
